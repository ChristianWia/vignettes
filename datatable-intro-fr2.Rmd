...
*extraire les lignes*, *sélectionner et faires des opérations* sur les colonnes,
...
package (available on GitHub only). It contains On-Time flights data from the
Bureau of Transportation Statistics for all the flights that departed from New
York City airports in 2014 (inspired by
...
We will see how to *add/update/delete* columns *by reference* and how to combine
them with `i` and `by` in the next vignette.
